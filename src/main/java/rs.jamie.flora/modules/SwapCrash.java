...
public class SwapCrash extends Module {
    ...
    public void onActivate() {
        super.onActivate();
        packet = new ClickSlotC2SPacket(mc.player.currentScreenHandler.syncId, mc.player.currentScreenHandler.getRevision(), 0, -999999, SlotActionType.QUICK_MOVE, new ItemStack(Items.AIR, -1), Int2ObjectMaps.emptyMap());
    }

    public SwapCrash() {
        super(FloraClient.MODULES, "swap-crash", "Inventory item swap crash ");
    }
